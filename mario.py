...
# cactus_img = pygame.image.load(os.path.join('assets_dir', 'cactus_bricks.png'))
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load('evilman.png')
        self.dragon_img = pygame.transform.smoothscale(self.dragon_img,(100,86))
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('flybullet.png')
